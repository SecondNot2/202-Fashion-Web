            ...
            {categories.map((category, index) => (
              ...
              >
                {category.link ? (
                  <motion.a
                    href={category.link}
                    className={`flex items-center ${textColor} hover:text-btn-primary focus:outline-none relative ${
                      hoveredCategory === index ? "text-btn-primary" : ""
                    }`}
                ...
                <AnimatePresence>
                  {activeCategory === index && category.subcategories && (
                    ...
                    >
                      <div
                        className="border-b border-illustration-stroke"
                        role="menu"
          ...
          <div className="hidden md:block relative w-xs max-w-xs">
            ...
            >
              ...
              <motion.button
                ...
                whileHover={{
                  backgroundImage:
                    "linear-gradient(to right, #f9bc60, #e16162)",
