  ...
  const seasonalCollections = [
    {
      ...
      description: "Cập nhật thời trang với bộ sưu tập mùa xuân của chúng tôi.",
    },
    {
      id: 2,
      name: "Mùa hè",
      ...
      description:
        "Chuẩn bị cho mùa hè với những phong cách mùa hè đầy sắc màu.",
    },
    {
      id: 3,
      name: "Mùa thu",
      image:
        "https://dongphucphuongthao.vn/wp-content/uploads/2022/08/trang-phuc-mua-thu-3.jpeg",
      description:
        "Mùa thu là mùa mà các nàng phải có cho mình những bộ trang phục thời thượng...",
    },
    {
      id: 4,
      name: "Mùa đông",
      ...
      description:
        "Cảm thấy thoải mái và trang nhã với bộ sưu tập mùa đông của chúng tôi.",
    },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {seasonalCollections.map((collection, index) => (
            ...
            >
              ...
              <div className="p-4">
                <h3 className="text-xl font-semibold mb-2 text-card-headline">
                  {collection.name}
                </h3>
                <p className="text-card-paragraph mb-4 line-clamp-2">
