      ...
      >
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <h2 className="text-2xl font-bold mb-2 text-card-headline">
                {product.name}
              </h2>
              ...
              <p className="text-card-paragraph mb-4">
                {product.description || "Chưa có mô tả sản phẩm."}
              </p>

              {sizes.length > 0 && (
                <div className="mb-4">
                  <h3 className="font-semibold mb-2 text-card-headline">
                    Kích thước:
                  </h3>
                      ...
                      <button
                        ...
                        className={`px-3 py-1 border rounded ${
                          selectedSize === size
                            ...
                            : "bg-card-bg text-card-paragraph"
                        }`}
              ...
              <div className="mb-4 mt-8 relative border-2 border-dashed border-btn-primary rounded-lg p-6">
                ...
                <ul className="text-card-paragraph list-disc list-inside space-y-1">
                  ...
                  <li>
                    Hỗ trợ trả lời thắc mắc qua{" "}
                    <a
                      href="https://m.me/second.not2"
              ...
              <div className="flex items-center space-x-4 mt-8">
                <div className="flex items-center border rounded-xl">
                  ...
                  <span className="px-7 py-1 text-card-headline">
                    {quantity}
                  </span>
                  <button
                ...
                <AddToCartButton product={product} onClick={handleAddToCart} />
              </div>
            </div>
          </div>
        </motion.div>
